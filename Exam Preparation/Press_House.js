function solveClasses(){
    ...
    class ShortReports extends Article{
        constructor(title, content, originalResearch){
            ...
            if(originalResearch.title == undefined || originalResearch.author == undefined){
        ...
        toString(){
            ...
            let result =  [super.toString(), `Original Research: ${this.originalResearch.title} by ${this.originalResearch.author}`]
    ...
    class BookReview extends Article{
        ...
        addClient(clientName,  orderDescription){
            ...
            let isAllreadyClient = this.clients.find(x => {
                return x.clientName == clientName && x.orderDescription == orderDescription;
            })
        ...
        toString(){
            ...
            let result = [super.toString(), `Book: ${this.book.name}`];
