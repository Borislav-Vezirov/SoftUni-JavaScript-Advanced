function solveClasses(){
    class Pet{
        ...
        addComment(comment){
            ...
            if(this.comments.includes(comment)){
                throw new Error('his comment is already added!')
            }
    ...
    class Cat extends Pet{
        ...
        toString(){
            ...
            let information = `${this.name} is a cat with ${this.insideHabits}`

            if(this.scratching == true){
                information += ", but beware of scratches.";
            }
    ...
    class Dog extends Pet{
        ...
        toString(){
            ...
            let result = [super.toString(), 'Main information:', `${this.name} is a dog with need of ${this.runningNeeds}km running every day and ${this.trainability} trainability.`];
